    ...
    <main>
        <div class="perfil">
            <div class="imgContainer">
                <img class="image" src="./images/foto_de_perfil.jpg"/>
            </div>
            <div class="perfil__txtContainer">
                <h1 class="perfil__titulo">INSCRIBIRSE</h1>
            </div>
            <div class="perfil__form">
                <form action="">
                    <label>Nombre</label><br>
                    <input type="text" id="" name="" value=<?php echo $nombre; ?> disabled><br><br>
                    <label>Sexo</label><br>
                    <input type="text" id="" name="" value=<?php echo $sexo; ?> disabled><br><br>
                    <label>Número telefónico</label><br>
                    <input type="text" id="" name="" value=<?php echo $tel; ?> disabled><br><br>
                    <label>Correo electrónico</label><br>
                    <input type="email" id="" name="" value=<?php echo $correo; ?> disabled><br><br>
                    <label>Plan</label><br>
                    ...
                    <input type="email" id="" name="" value=<?php echo $fecha_registro; ?> disabled><br><br>
                  </form> 
                  <div class="perfil__button">
                        <button class="perfil__crear">
                            <a href="./productos.php">Tienda</a>
                        </button>
                        <button class="perfil__crear">
                            <a href="./perfil.php">Guardar</a>
                        </button>
                    </div>
            </div>
        </div>
