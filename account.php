...
<body>
    ...
    <main>
        <div class="formulario">
            <div class="formulario__txtContainer">
                <h1 class="formulario__titulo">INSCRIBIRSE</h1>
            </div>
            <div class="formulario__form">
                <form action="account1.php" method="post">
                    <label>Nombre</label><br>
                    <input type="text" id="" name="nombre" value=""><br><br>
                    <label>Sexo</label><br>
                    <select id="" name="sexo">
                    ...
                    <input type="text" id="" name="tel" value=""><br><br>
                    <label >Correo electrónico</label><br>
                    <input type="email" id="" name="correo" value=""><br><br>
                    <label>Contraseña</label><br>
                    <input type="password" id="" name="contrasena" value=""><br><br>
                    <label>Confirmar Contraseña</label><br>
                    <input type="password" id="" name="conf_contrasena" value=""><br><br>
                    <label>Plan</label><br>
                    <select id="" name="plan">
